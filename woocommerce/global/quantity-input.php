...
if ( $max_value && $min_value === $max_value ) {
	...
	$labelledby = ! empty( $args['product_name'] ) ? sprintf( __( '%s quantity', 'cit' ), strip_tags( $args['product_name'] ) ) : '';
	?>
	<div class="quantity">
		<label class="screen-reader-text" for="<?php echo esc_attr( $input_id ); ?>"><?php esc_html_e( 'Quantity', 'cit' ); ?></label>
		<div class="vct-input-qty">
			<input
					...
					title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'cit' ); ?>"
					size="4"
