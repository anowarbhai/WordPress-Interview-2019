		...
		<div class="gallery-slider">
			...
			foreach ( $gallery_images_ids as $id ) :
				if ( 'full_width' === $featured_image_width ) {
					$image = wp_get_attachment_image_src( $id, 'citthemestarter-featured-loop-image-full' );
				} else {
					$image = wp_get_attachment_image_src( $id, 'citthemestarter-featured-loop-image-boxed' );
				}
				?>
