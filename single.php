											...
											<div class="row">
												<div class="col-md-5">
													<div class="nav-previous">
														...
														previous_post_link(
															'%link',
															'<span class="meta-nav">' . esc_html__( 'Previous', 'cit' ) . '</span><span class="screen-reader-text">' . esc_html__( 'Previous post:', 'cit' ) . '</span><span class="post-title">%title</span>'
														);
														?>
													</div><!--nav-previous-->
												</div><!--.col-md-5-->
												<div class="col-md-5 col-md-offset-2">
													<div class="nav-next">
														...
														next_post_link(
															'%link',
															'<span class="meta-nav">' . esc_html__( 'Next', 'cit' ) . '</span><span class="screen-reader-text">' . esc_html__( 'Next post:', 'cit' ) . '</span><span class="post-title">%title</span>'
														);
														?>
													</div><!--.nav-next-->
												</div><!--.col-md-5-->
