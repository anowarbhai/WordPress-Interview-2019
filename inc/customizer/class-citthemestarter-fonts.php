...
class citthemestarter_Fonts {
	...
	protected static function vct_get_fonts_list() {
		$heading1 = array(
			1 => array(
				'label' => sprintf( '--- %s ---', esc_html__( 'Standard Fonts', 'cit' ) ),
			),
		);
		$standard_fonts = self::vct_theme_standard_fonts();
		$heading2 = array(
			2 => array(
				'label' => sprintf( '--- %s ---', esc_html__( 'Google Fonts', 'cit' ) ),
			),
		);
	...
	public static function vct_theme_get_google_font_uri( $fonts ) {
		...
		$subset = get_theme_mod( 'cit_fonts_and_style_subsets', 'all' );
	...
	public static function vct_theme_font_subsets() {
		return array(
			'all'     => esc_html__( 'All', 'cit' ),
			'cyrillic'   => esc_html__( 'Cyrillic', 'cit' ),
			'cyrillic-ext' => esc_html__( 'Cyrillic Extended', 'cit' ),
			'devanagari'  => esc_html__( 'Devanagari', 'cit' ),
			'greek'    => esc_html__( 'Greek', 'cit' ),
			'greek-ext'  => esc_html__( 'Greek Extended', 'cit' ),
			'khmer'    => esc_html__( 'Khmer', 'cit' ),
			'latin'    => esc_html__( 'Latin', 'cit' ),
			'latin-ext'  => esc_html__( 'Latin Extended', 'cit' ),
			'vietnamese'  => esc_html__( 'Vietnamese', 'cit' ),
		);
	}
	...
	public static function vct_theme_google_font_variants( $font, $variants = array() ) {
		...
		foreach ( $font_types as $font_type ) {
			$font_family = get_theme_mod( 'cit_fonts_and_style_' . $font_type . '_font_family' );
			if ( $font_family === $font ) {
				$font_weight = get_theme_mod( 'cit_fonts_and_style_' . $font_type . '_weight', '400' );
